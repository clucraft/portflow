        ...
        <div className="p-4 border-b border-surface-600">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <a href="https://github.com/clucraft/portflow/blob/main/CHANGELOG.md" target="_blank" rel="noopener noreferrer" className="text-[10px] text-zinc-600 hover:text-primary-400 transition-colors">v{__APP_VERSION__}</a>
            </div>
          </div>
        </div>
