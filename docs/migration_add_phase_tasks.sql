-- Migration: Add phase_tasks JSONB column
-- Stores per-phase subtask checklists (e.g., Phase 4 has AA/CQ config, Holiday Sets, Phone Deployment)

ALTER TABLE migrations ADD COLUMN IF NOT EXISTS phase_tasks JSONB DEFAULT '{}';

-- Recreate dashboard view to include phase_tasks
