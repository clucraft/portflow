...
try {
    ...
    Set-CsPhoneNumberAssignment -Identity "${user.upn}" -PhoneNumber "${user.phone_number}" -PhoneNumberType ${migration.routing_type === 'direct_routing' ? 'DirectRouting' : 'OperatorConnect'}
